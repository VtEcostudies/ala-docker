...
#VT Geo Centroid: 44.0687N 72.6658W
...
#./config/ala-hub-config.properties:exploreYourArea.location=Sweden
#./config/generic-hub-config.properties:exploreYourArea.location=Sveriges Mittpunkt, Flataklocken, Sweden
#./config/ala-collectory-config.properties:regionName=Sweden
#./config/ala-collectory-config.properties:eml.country=Sweden
#./config/generic-collectory-config.properties:regionName=Sweden
#./config/generic-collectory-config.properties:eml.organizationName=GBIF Sweden
#./config/generic-collectory-config.properties:eml.country=Sweden
